...
const PrivacyPolicyPage = () => {
  return (
    <ContainerLayout>
      <PageHeader variant="h2">Privacy Policy</PageHeader>
      <Content>
        ...
        <p>CleanThat Cleaning Solutions, 180 John Street, Toronto ON M5T 1X5</p>
        <p>Owner contact email: clean@cleanthat.ca</p>
        ...
        the identification or identifiability of a natural person. Usage Data
